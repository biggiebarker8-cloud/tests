...
- Injects built-in skill context for image creation, image editing, comic book creation, picture design, short video creation, website building, website permissions management (excluding payment/admin charge privileges), core memory vault, story universe continuity, adaptive self-learning, and auto-selected plug-ins/skills when prompts or image inputs indicate those workflows.
